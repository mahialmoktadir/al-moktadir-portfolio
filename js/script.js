...
const PROJECTS_DATA = [
  { id: "proj-1", title: "Championship Season Social Kit", category: "social_media_graphics", imageUrl: "assets/images/Team Liquid ID MLBB Roster - MPL ID S13.jpg", tags: ["Social Media Banner", "Match Day", "Branding"], description: "A unified suite of social match-day announcements, player-of-the-match awards, and calendar outlines constructed to maintain clean corporate brand alignment across Twitter, Instagram, and Discord channels.", features: ["Premium templates pack", "Cohesive typographic grid system", "Dynamic tournament layouts", "Unified brand color profile"] },
  { id: "proj-2", title: "Cyber Phantom Gaming Logo", category: "esports_logos", imageUrl: "assets/images/esports_logo_1781335710014.jpg", tags: ["Mascot Logo", "Phantom Theme", "Vector Art"], description: "A ghostly cyber-phantom mascot logo with glowing neon accents, custom typography, and a dark holographic shield backdrop for competitive gaming identity.", features: ["Vector scalable artwork", "Neon glow layer effects", "Dual-tone color palette", "Twitch/Discord avatar ready"] },
  { id: "proj-3", title: "Elite SaaS Admin Panel", category: "web_projects", imageUrl: "assets/images/web_dashboard_1781335760467.jpg", tags: ["React Dashboard", "Admin UI", "Analytics"], description: "A comprehensive SaaS administration panel with real-time analytics, user management, role-based access, and beautifully animated data visualization widgets.", features: ["Real-time data streams", "Role-based UI states", "Responsive sidebar layout", "Dark/light theme toggle"] },
  { id: "proj-4", title: "Velocity Esports Jersey Kit", category: "jersey_designs", imageUrl: "assets/images/jersey_design_1781335724148.jpg", tags: ["Esports Jersey", "Speed Theme", "Sublimation"], description: "High-velocity racing-inspired esports jersey with aerodynamic stripe patterns, carbon fiber textures, and sponsor-ready chest and sleeve placements.", features: ["Sublimation print ready", "Sponsor panel layouts", "Speed-line gradient effects", "Player name/number zones"] },
  { id: "proj-5", title: "Twitch Streamer Royal Package", category: "stream_assets", imageUrl: "assets/images/roster_design_1781335744874.jpg", tags: ["Stream Package", "Twitch", "Overlay Kit"], description: "A premium royal-themed stream overlay package featuring animated borders, custom alert boxes, a sleek chat panel, and stream-starting screens with gold accents.", features: ["OBS Studio ready", "Animated alert widgets", "Custom emote slots", "Scene transition effects"] },
  { id: "proj-6", title: "Titan Esports Roster Reveal", category: "roster_designs", imageUrl: "assets/images/Marsha Lenathea.jpg", tags: ["Roster Card", "Team Reveal", "Titan Theme"], description: "A bold roster reveal card featuring holographic player portraits, titanium-textured nameplates, and dynamic team role indicators for tournament announcements.", features: ["Player stat overlay slots", "Holographic foil effects", "Role icon indicators", "Social media optimized"] },
  { id: "proj-7", title: "Cyber Arena Welcome Screen", category: "welcome_banners", imageUrl: "assets/images/Player welcome - POSTER DESIGN.jpg", tags: ["Welcome Banner", "Cyber Theme", "Event Start"], description: "An immersive cyber-arena welcome screen with neon grid backgrounds, animated countdown timers, and sponsor showcase panels for major tournament kickoffs.", features: ["Countdown widget included", "Sponsor logo zones", "Neon grid background", "1080p broadcast ready"] },
  { id: "proj-8", title: "MVP Highlight Cinematic", category: "video_editing", imageUrl: "assets/images/mvp.jpg", tags: ["Cinematic Reel", "MVP Edit", "Sound Design"], description: "A cinematic MVP highlight reel featuring slow-motion clutch moments, custom color grading, bass-synced transitions, and broadcast-style lower thirds.", features: ["Color graded footage", "Synced audio design", "Lower third graphics", "Slow-motion keyframes"] }
];
